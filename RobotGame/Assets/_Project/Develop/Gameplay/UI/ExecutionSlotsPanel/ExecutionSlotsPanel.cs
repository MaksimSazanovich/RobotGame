...
namespace Unity_one_love.RobotGame
{
    ...
    {
        public List<float> CurrentPositionList { get; private set; }
        ...
        private void Start()
        {
            CurrentPositionList = PositionsLists[2].ToList();
...
//            Debug.Log("last slot: " + lastSlot.RectTransform.position.y);
            Debug.Log("CurrentSlotList.Length: " + CurrentPositionList.Count);
        }
        ...
        private void HandleDragged(float y)
        {
            ...
            for (int i = 0; i < executionSlots.Count; i++)
            {
                ...
                executionSlots[i].RectTransform.position = new Vector3(transformPosition.x,
                    CurrentPositionList[CurrentPositionList.Count - 1 - i], transformPosition.z);
            }
        }
        ...
        private void AddSlot()
        {
            ...
            CurrentPositionList = PositionsLists[transform.GetComponentsInChildren<ExecutionSlot>().Length - 1].ToList();
        }
